-- SOLUÇÃO SIMPLES - FUNCIONÁRIO + AUTH + PROFILES
...
BEGIN
  ...
  -- Criar perfil na tabela profiles (sempre FUNCIONARIO)
  INSERT INTO public.profiles (user_id, nome, papel, ativo)
  VALUES (user_id, p_nome, 'FUNCIONARIO', true);
...
UNION ALL
SELECT 'FUNCIONARIO' as tabela, id::text as id, nome as email, created_at FROM public.funcionarios WHERE nome = 'Funcionário Teste';

-- 4. MENSAGEM FINAL
DO $$
BEGIN
  RAISE NOTICE '🎉 FUNÇÃO SIMPLES CRIADA!';
  RAISE NOTICE '✅ Cria funcionário + auth + profiles de uma vez';
  RAISE NOTICE '✅ Agora o frontend só precisa chamar esta função';
END $$;
